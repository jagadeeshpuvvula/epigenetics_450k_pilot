...
#plot
```{r}
ggplot(df_nap_fluo, aes(x=effect_size, y=-log10(p_value), color=beta_dir))+
  geom_point(size=0.2)+
  geom_text_repel(data = subset(df_nap_fluo, fdr < 0.05),
  ...
  facet_wrap(~ factor(filename, levels=c(
    "nap1_fp", "nap1_mp", "nap1_mom_cmbc", "fluo2_fp", "fluo2_mp",
    "pyr1_fp", "pyr1_mp", "phen4_mp","m_cnp_mp", "bpa_mp"
    )),
...
ggsave("~/Documents/methylation_pilot/res_annotated_cell_cnt/volcano_plt_p1.tiff", 
