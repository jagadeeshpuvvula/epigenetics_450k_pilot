...
```{r}
cbmc_pheno<- cbmc_pheno |> select("participant_id", "CD8T", "CD4T", "NK", "Bcell", "Mono", "Gran", "nRBC") |>
  rename_at(vars(2:8), ~ paste0("cbmc_", .))
...
vis_df |>
  ...
  scale_fill_gradientn(
    colors = c("lightblue", "white", "lightpink"),
    ...
    guide = guide_colorbar(title.position = "left",
                                              title.hjust = 1,
                                              title.vjust = 1),
    name = expression(beta[italic(lm)])
  )  +
  theme_bw() +
